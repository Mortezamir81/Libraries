...
namespace Softmax.Logging.NLogAdapter
{
	internal static class ObjectDestructurer
	{
		// A thread-safe cache for our compiled destructuring functions.
		private static readonly ConcurrentDictionary<Type, Func<object, IEnumerable<KeyValuePair<string, object?>>>> _cache = new ConcurrentDictionary<Type, Func<object, IEnumerable<KeyValuePair<string, object?>>>>();
